...
export function onMessagesRead(
  callback: (conversationId: number, userId: number, readAt: string) => void,
): void {
  getConnection().on("MessagesRead", callback);
}

export function offMessagesRead(
  callback: (conversationId: number, userId: number, readAt: string) => void,
): void {
...
export function onMessageDelivered(
  callback: (conversationId: number, userId: number) => void,
): void {
  getConnection().on("MessageDelivered", callback);
}

export function offMessageDelivered(
  callback: (conversationId: number, userId: number) => void,
): void {
