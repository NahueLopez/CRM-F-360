...
export const chatService = {
  ...
  getOrCreateDm: (userId: number) => api.post<Conversation>(`/chat/conversations/dm/${userId}`, {}),
  ...
  getTotalUnread: () => api.get<{ count: number }>("/chat/unread"),

  getUsers: () => api.get<{ id: number; fullName: string; email: string }[]>("/chat/users"),
};
