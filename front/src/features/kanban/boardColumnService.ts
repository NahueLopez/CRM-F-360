...
export const boardColumnService = {
  getByProject: (projectId: number) => api.get<BoardColumn[]>(`/projects/${projectId}/columns`),
  ...
  remove: (projectId: number, id: number) => api.delete(`/projects/${projectId}/columns/${id}`),
};
