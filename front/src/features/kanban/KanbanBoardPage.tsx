...
import type { BoardColumn as ColumnType } from "./types";
import type { User } from "../users/types";
import { taskService } from "../tasks/taskService";
import { boardColumnService } from "./boardColumnService";
import { projectMemberService } from "../projects/projectMemberService";
...
const KanbanBoardPage: React.FC = () => {
  ...
  const handleDragEnd = async (event: DragEndEvent) => {
    ...
    const colTasks = (tasksByColumn.get(targetColumnId) ?? []).filter((t) => t.id !== taskId);
