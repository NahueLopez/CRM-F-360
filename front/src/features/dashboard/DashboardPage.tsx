...
const DashboardPage = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      icon: (report?.overdueTasks ?? 0) > 0 ? "⚠️" : "✨",
      link: undefined,
    },
    {
      label: "Horas mes",
      value: `${(report?.totalHoursThisMonth ?? 0).toFixed(1)}h`,
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {cards.map((c) => (
              ...
              >
                ...
                <div
                  className={`absolute bottom-0 left-0 right-0 h-[2px] bg-gradient-to-r ${c.gradient} opacity-0 group-hover:opacity-100 transition-opacity`}
                />
              </button>
            ))}
          </div>
            ...
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <ChartCard
                  ...
                  subtitle={`${report.totalProjects} proyectos`}
                  icon="📊"
                >
                ...
                <ChartCard
                  ...
                  subtitle={`${report.totalTasks} tareas totales`}
                  icon="🎯"
                >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                ...
                <div className="lg:col-span-3">
                  <ChartCard
                    ...
                    subtitle="Progreso, tareas y burn de horas"
                    icon="🏥"
                  >
                    {healthData.length === 0 ? (
                      ...
                      <div className="space-y-3">
                        {healthData.slice(0, 5).map((p) => {
                          const taskPercent =
                            p.totalTasks > 0 ? (p.completedTasks / p.totalTasks) * 100 : 0;
                          ...
                          return (
                            <div
                              key={p.projectId}
                              className="group p-3.5 rounded-xl bg-slate-800/30 border border-slate-700/30 hover:border-slate-700/60 transition-all"
                            >
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2.5">
                                  ...
                                  <span
                                    className={`text-[10px] w-10 text-right tabular-nums ${p.hoursBurnPercent > 90 ? "text-red-400" : "text-slate-500"}`}
                                  >
                  ...
                  <ChartCard title="Horas por usuario" subtitle="Este mes" icon="👥">
                    {usersBarData.length === 0 ? (
                      ...
                      <div className="space-y-2.5">
                        {(() => {
                          const filtered = (report?.hoursByUser ?? [])
                            .filter((u) => u.hoursThisMonth > 0)
                            .slice(0, 7);
              ...
              <ChartCard
                ...
                subtitle="Últimas interacciones registradas"
                icon="📋"
              >
