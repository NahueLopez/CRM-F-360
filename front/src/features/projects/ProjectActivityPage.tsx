      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <Link to="/projects" className="text-xs text-slate-500 hover:text-slate-300 transition">
              ← Proyectos
            </Link>
            {project && (
              <Link
          ...
          return (
            ...
            >
              ...
              <p className="text-[10px] text-slate-500 uppercase tracking-wider">
                {type === "StatusChange" ? "Cambios" : type + "s"}
              </p>
            </button>
          );
        })}
              ...
              <div className="relative pl-6 border-l-2 border-slate-700/50 space-y-3">
                {acts.map((a) => (
                  <div key={a.id} className="relative">
                    ...
                    <div
                      className={`rounded-xl p-4 border transition-all hover:translate-x-1 ${
                        ACTIVITY_COLORS[a.type] ?? "border-slate-700/50 bg-slate-800/30"
                      }`}
                    >
